...
public class UnitPathArcCircleCommand extends UnitPathCommand {
    ...
    public UnitPathArcCircleCommand(Unit lineWidth) {
        super(UnitPathCommandType.ARC_CIRCLE, lineWidth);
    }
    ...
    private Array<Vector2WithWidth> renderCircle(Array<Vector2WithWidth> path, Vector2 p0, Vector2 p1, float radius,
        ...
        for (int i = 0; i < 100; i++) {
            ...
            path.add(new Vector2WithWidth(point, MathUtils.lerp(startWidth, endWidth, i / 100f)));
        }
