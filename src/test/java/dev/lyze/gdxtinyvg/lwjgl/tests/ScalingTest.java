...
public class ScalingTest extends LibgdxLwjglUnitTest {
    private TinyVG tvg;
    ...
    public void render() {
        ...
        tvg.setScale(tvg.getScaleX() + 0.5f * Gdx.graphics.getDeltaTime());
        tvg.setRotation(tvg.getRotation() + 50 * Gdx.graphics.getDeltaTime());
